    ...
    class PingPongThread extends HandlerThread implements Handler.Callback {
        ...
        protected void onLooperPrepared() {
            ...
            if (mMyType.equals(PingPong.PING)) {
                pingHandler = new Handler(this);
            } else {
                pongHandler = new Handler(this);
            }
        ...
        public boolean handleMessage(Message reqMsg) {
            ...
            // appropriate code.
            if (reqMsg.getTarget() == pingHandler) {
                createPingPongUIString(PingPong.PING);
            } else {
                // Shutdown the HandlerThread to the main PingPong
                // thread can join with it.
                createPingPongUIString(PingPong.PONG);
            }
        ...
        private void createPingPongUIString(PingPong pingPong) {
            mOutputStrategy.print(pingPong.toString() + "(" + mIterationsCompleted + ")" + System.getProperty("line.separator"));
        }
    }
